            ...
            <div class="flex gap-4 mb-4">
                <div class="flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700 flex-1">
                    <input 
                        ...
                        checked 
                        id="bordered-radio-4" type="radio" value="Laravel" name="bordered-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="bordered-radio-4" class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Laravel</label>
                </div>
                <div class="flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700 flex-1">
                    <input 
                        _="on click set #lmstdfyForm's @docs to 'laravelapi'" 
                        id="bordered-radio-1" type="radio" value="Laravel API" name="bordered-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="bordered-radio-1" class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Laravel API</label>
                </div>
                <div class="flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700 flex-1">
                    <input 
