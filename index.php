    ...
    <div class="container mx-auto max-w-5xl pt-20">
        ...
        <form class="mt-20" method="GET" action="search.php" onsubmit="return false">   
            ...
            <div class="relative">
                ...
                <button 
                    _="on click get the (value of the previous <input/>) then log it then writeText('https://lmstdfy.readthedocs.wtf/search.php?q=' + it) into the navigator's clipboard then show #output"
